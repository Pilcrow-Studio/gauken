...
<template>
  ...
  <Teleport to="body">
    ...
    >
      ...
      <button
        v-if="currentIndex > 0"
        class="absolute left-4 top-1/2 -translate-y-1/2 z-60 text-white hover:text-gray-300 transition-colors"
      ...
      <button
        ...
        class="absolute right-4 top-1/2 -translate-y-1/2 z-60 text-white hover:text-gray-300 transition-colors"
      ...
      >
        ...
        >
          ...
          <div class="space-y-2 text-sm text-gray-400">
            ...
            <p v-if="currentArtwork.data.price" class="text-white font-medium">
